 ...
 *  (1) Removes the "previous month" (الشهر السابق / السابق) column
 *      from every data-entry items-table. Each line item now has a
 *      single value tied to the chosen entry month.
 *  (2) Adds an "entry month" selector at the top of each financial
 *      statement tab, mirroring the existing current-month list
 *      (#month1). Choosing a month inside any statement records the
 *      financial statements on the basis of that month (drives the
 *      app's own period logic via #month1).
 * Purely additive DOM work inside #editor-panel; no saved data shape
 * is changed.
 * =================================================================== */
(function lnDataEntryModule() {
  ...
  function injectStyles() {
    ...
    var css =
      // Hide the 3rd column (الشهر السابق / السابق / Previous).
      // Every data-entry table is [Item][Current][Previous][Delete].
